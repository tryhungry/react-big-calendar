...
var _initialiseProps = function _initialiseProps() {
  ...
  this.renderEvents = function () {
    ...
    return styledEvents.map(function (_ref, idx) {
      ...
      var _isSelected = (0, _selection.isSelected)(event, selected) && selectable === true;
      ...
      var myStyle = _extends({}, xStyle, (_extends2 = {
        top: top + '%',
        height: height + '%'
      }, _extends2[isRtl ? 'right' : 'left'] = Math.max(0, xOffset) + '%', _extends2.width = width + '%', _extends2.overflow = 'visible', _extends2));
      if (event.recurring) {
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          _isSelected && _react2.default.createElement(
            'div',
            { style: {
                backgroundColor: '#eee',
                position: 'absolute',
              ...
              onClick: function onClick(e) {
                e.preventDefault();e.stopPropagation();onDelete && onDelete(event);
              } },
            'X'
          )
        )
